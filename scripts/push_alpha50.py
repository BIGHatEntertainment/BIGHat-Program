...
FILES = [
    ("/app/backend/VERSION.txt", "backend/VERSION.txt",
     "chore(release): bump -> 32.0.0-alpha.50"),
    ("/app/src-tauri/tauri.conf.json", "src-tauri/tauri.conf.json",
     "chore(release): bump tauri.conf.json -> 32.0.0-alpha.50"),
    ("/app/backend/native_slides.py", "backend/native_slides.py",
     "feat(alpha.50): VERBATIM port of prototype slide structure (14/13/7 slides per type; .gif(STOP); no-title answer slides)"),
    ("/app/backend/tests/test_alpha50_prototype_slide_parity.py",
     "backend/tests/test_alpha50_prototype_slide_parity.py",
     "test(alpha.50): 12 tests locking in exact prototype slide positions"),
    ("/app/backend/tests/test_alpha46_disk_truth_and_native_slides.py",
     "backend/tests/test_alpha46_disk_truth_and_native_slides.py",
     "test(alpha.50): update alpha.46 to expect 14 slides for MC (prototype spec)"),
    ("/app/memory/CHANGELOG.md", "memory/CHANGELOG.md",
     "docs(alpha.50): changelog entry"),
]
