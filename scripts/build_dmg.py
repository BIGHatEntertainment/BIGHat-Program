...
def main(argv: list[str] | None = None) -> int:
    ...
    # Note: v31.0.12 removed the frontend/public/downloads/ mirror.
    # Customer-facing downloads resolve via api.bighat.live/api/downloads/auto
    # against GitHub Releases — the local mirror only bloated the next macOS
    # build by 180MB per cycle.
    return 0
